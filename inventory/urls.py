...
urlpatterns = [
    ...
    path("books/<int:pk>/documents/<str:document_type>/", phase9_views.book_document, name="book_document"),
    ...
    path("tshirts/allocations/<int:pk>/documents/<str:document_type>/", phase9_views.paid_tshirt_document, name="paid_tshirt_document"),
